local osclock = os.clock
	...
	local aligns={
		...
		{ meshid = "18919712035", PartName = "Torso", C0 = CFrame.identity, textureid = "18430134193" },
		{PartName="Left Leg",meshid="18881741455",textureid="18430134193",C0=angles(0,0,0)},
		{PartName="Right Leg",meshid="18881739115",textureid="18430134193",C0=angles(0,0,0)},
		{PartName="Left Arm",meshid="14255522247",textureid="",C0=angles(1.5707963267948966,0,1.5707963267948966)},
		{PartName="Right Arm",meshid="14255522247",textureid="",C0=angles(-1.5707963267948966,0,1.5707963267948966)},
		{PartName="Left Arm",meshid="12344207333",textureid="",C0=angles(2,0,0)},
		{PartName="Right Arm",meshid="12344206657",textureid="",C0=angles(2,0,0)},
		{PartName="Left Arm",meshid="13831073174",textureid="",C0=cfMul(cf(0.017,0,-0.23),angles(-1.4835298641951802,-0.15707963267948966,2.199114857512855))},
		{PartName="Right Arm",meshid="13839903766",textureid="",C0=cfMul(cf(0,-0.62,-0.01),angles(1.6580627893946132,0.15707963267948966,-2.199114857512855))},
		{PartName="Left Leg",meshid="11159370334",textureid="11159285454",C0=angles(1.5707963267948966,0,1.5707963267948966)},
		{PartName="Right Leg",meshid="12652772399",textureid="12652775021",C0=cf(0,-0.125,0)},
		{PartName="Left Leg",meshid="14768684979",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Right Leg",meshid="14768684979",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Torso",meshid="14768666349",textureid="",C0=cf_0},
		{PartName="Torso",meshid="14241018198",textureid="",C0=cf_0},
		{PartName="Torso",meshid="13421774668",textureid="",C0=cf_0},
		{PartName="Left Arm",meshid="117287001096396",textureid="",C0=cf_0},
		{PartName="Right Arm",meshid="117287001096396",textureid="",C0=cf_0},
		{PartName="Left Arm",meshid="90736849096372",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Right Arm",meshid="105141400603933",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Left Arm",meshid="17374767929",textureid="",C0=angles(1.5707963267948966,0,1.5707963267948966)},
		{PartName="Right Arm",meshid="17374767929",textureid="",C0=angles(-1.5707963267948966,0,1.5707963267948966)},
		{PartName="Left Leg",meshid="121304376791439",textureid="",C0=cf_0},
		{PartName="Right Leg",meshid="121304376791439",textureid="",C0=cf_0},
		{PartName="Left Leg",meshid="139733645770094",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Right Leg",meshid="99608462237958",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Left Leg",meshid="17387586286",textureid="",C0=angles(1.5707963267948966,0,1.5707963267948966)},
		{PartName="Right Leg",meshid="17387586286",textureid="",C0=angles(-1.5707963267948966,0,1.5707963267948966)},
		{PartName="Torso",meshid="110684113028749",textureid="",C0=cf_0},
		{PartName="Torso",meshid="127552124837034",textureid="",C0=angles(0,0,1.5707963267948966)},
		{PartName="Left Arm",meshid="4324138105",textureid="4324138210",C0=angles(-1.6144295580947547,1.5707963267948966,0)*cf(-0.125,0.3,0)},
		{PartName="Left Arm",meshid="4154474745",textureid="4154474807",C0=angles(1.5271630954950384,-1.5707963267948966,0)*cf(-0.125,-0.3,0)},
		{PartName="Right Arm",meshid="3030546036",textureid="3650191503",C0=angles(1.5271630954950384,1.5707963267948966,0)*cf(0.125,-0.3,0)},
		{PartName="Right Arm",meshid="3030546036",textureid="3443321249",C0=angles(-1.6144295580947547,-1.5707963267948966,0)*cf(0.125,0.3,0)},
		...
		-- noob rig extras
		{PartName="Left Arm",meshid="137702817952968",textureid="135650240593878",C0=angles(0,0,80.05)},
		{PartName="Right Arm",meshid="137702817952968",textureid="135650240593878",C0=angles(0,0,80.05)},
		{PartName="Left Leg",meshid="137702817952968",textureid="73798034827573",C0=angles(0,0,80.09)},
		{PartName="Right Leg",meshid="137702817952968",textureid="73798034827573",C0=angles(0,0,80.09)},
		{PartName="Torso",meshid="126825022897778",textureid="125975972015302",C0=angles(0,0,0)},

		-- screen accessories
		{PartName="Left Arm",meshid="139733645770094",textureid="130809869695496",C0=angles(0,0,80.09)},
		{PartName="Right Arm",meshid="90736849096372",textureid="79186624401216",C0=angles(0,0,80.09)},
		{PartName="Left Leg",meshid="99608462237958",textureid="130809869695496",C0=angles(0,0,80.09)},
		{PartName="Right Leg",meshid="105141400603933",textureid="71060417496309",C0=angles(0,0,80.09)},
		{PartName="Torso",meshid="126825022897778",textureid="130689541138804",C0=angles(0,0,0)},
		{PartName="Right Leg",meshid="100128920324073",textureid="133680105074740",C0=angles(rad(-75),rad(15),rad(-20))},
		{PartName="Left Arm",meshid="130309145260656",textureid="82390202293774",C0=angles(rad(-75),rad(-15),rad(20))},
		{PartName="Left Leg",meshid="130309145260656",textureid="93374633946646",C0=angles(rad(-75),rad(-15),rad(20))},
		{PartName="Right Arm",meshid="100128920324073",textureid="97155254696037",C0=angles(rad(-75),rad(15),rad(-20))},
	}
	...
	local reanimate=function()
		...
		if c and IsDescendantOf(c,ws) then
			cfr=QueryDescendants(c,">BasePart#HumanoidRootPart")[1] or QueryDescendants(c,">BasePart#Torso")[1] or QueryDescendants(c,">BasePart#UpperTorso")[1] or (c and FindFirstChildWhichIsA(c,"BasePart"))
			if cfr then
		...
		local function spawnLightning()
			if lightningParts then return end
			...
			local boltData = {
				{cf(-129.1,8.13,15.62,-0.97,-0.21,-0.13,0.16,-0.93,0.34,-0.19,0.31,0.93), 2,2,2},
				...
				{cf(-129.23,10.69,13.89,-0.97,-0.24,-0.03,-0.24,0.96,0.15,-0.01,0.16,-0.99), 2,2,2},
			...
			lightningParts = { LS = LS, LC = LC, bolts = bolts }
		end

		-- Lightning heartbeat
		tinsert(cons, Connect(heartbeat, function()
			if not lightningActive or not lightningParts then return end
			if not c then destroyLightning() return end

			local rightArmPart = getPart("Right Arm")
			if not rightArmPart then return end

			local armCF = cframes[rightArmPart]
			if not armCF then return end
				...
				if isWalking then
					if walkSpeed==0 then
						...
						if onground then
							...
							insSet(cam,"CFrame",camcf)
							if not attackActive then lerpsIdle() end
							noYvelTime=min(noYvelTime+delta*0.3,1)
							if not attackActive then xzvel=xzvel*(1-noYvelTime) end
						elseif Yvel>0 then
							...
							cframes[rootpart]=cfr
							insSet(cam,"CFrame",camcf)
							if not attackActive then lerpsJump() end
							noYvelTime=0
						else
							pos=pos+v3_010*Yvel*delta
							cfr=cfl(pos,pos+camcfLV*v3_101)
							...
							cframes[rootpart]=cfr
							insSet(cam,"CFrame",camcf)
							if not attackActive then lerpsFall() end
							noYvelTime=0
						end
					else
						...
						if onground then
							...
							cframes[rootpart]=cfr
							insSet(cam,"CFrame",camcf)
							if not attackActive then lerpsWalk() end
							noYvelTime=min(noYvelTime+delta*0.3,1)
							if not attackActive then xzvel=xzvel*(1-noYvelTime) end
						elseif Yvel>0 then
			...
			if attackActive then
				...
				if attackProgress >= 1 then
					...
					if modeAttacks then
						...
						if attackDef and attackDef.fn then attackDef.fn() end
					end
				end
			end
			setsimrad()
		...
		local function breakPart(targetPart)
			...
			if brokenParts[targetPart] then return false end
	...
	local function C_c()
		...
		reBtn.MouseButton1Click:Connect(function()
			...
			local function getLightningActive() return t.getLightningActive() end
			local function setLightningActive(v) t.setLightningActive(v) end
			...
			local function soundFromLink(link)
				...
				if not isfile(path) then
					...
					if not req then warn("No http request function found") return nil end
					local res = req({ Url = link, Method = "GET" })
					if not res.Success then warn("Download failed: " .. tostring(res.StatusCode)) return nil end
			...
			attacks["default"]["e"] = {
				...
				fn = function()
					...
					LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-0.8344764040227517,0.5061554490474229,-0.2005674127946824),angles(0.6970563443828333+0.1*sin(sine*2),-1.048633976188762,0.6970563443828333)),deltaTime)
					RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-1,0),angles(-0.2825384043722083+0.1*sin(sine*2),1.308852287298644,0.1462563217432109)),deltaTime)
					RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(0.8144311737595942,0.5,0),angles(0.5605589662046579+1*sin(sine*15),2.150156649630022-1*sin(sine*15),0.3273198786010107-1*sin(sine*15))),deltaTime)
					AJBackAccessory.C0=cf(1,0,0)*angles(rad(0),rad(0),rad(-72))
					AJBackAccessory.Part1=getPart("Right Arm") AJBackAccessory.C1=cf_0
			...
			_G.AttackInputConnection = UIS.InputBegan:Connect(function(input, gpe)
				...
				if mouseBind then
					...
					if mouseBind.modeKey and mouseBind.modeKey ~= activeModeStr then return end
				...
				local activeModeStr = tostring(_G.ModeV or "default")
				if bind.modeKey and bind.modeKey ~= activeModeStr then return end
			...
			do
				...
				g.Color = ColorSequence.new{
					ColorSequenceKeypoint.new(0,     Color3.fromRGB(95,  84,  158)),
			...
			G2L["f"].FontFace = Font.new([[rbxasset://fonts/families/PressStart2P.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal)
